...
const CreatePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <input placeholder="Food Type" value={foodType} onChange={(e) => setFoodType(e.target.value)} />
      <input type="number" placeholder="Max Claims" value={maxClaims} onChange={(e) => setMaxClaims(Number(e.target.value))} />
